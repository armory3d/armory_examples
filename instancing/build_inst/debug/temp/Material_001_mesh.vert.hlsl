...
void vert_main()
{
    ...
    float3 _147 = mul(spos.xyz, mirot);
    spos = float4(_147.x, _147.y, _147.z, spos.w);
    wnormal = mul(wnormal, transpose(SPIRV_Cross_Inverse(mirot)));
    float3 _159 = spos.xyz * iscl;
    spos = float4(_159.x, _159.y, _159.z, spos.w);
    float3 _166 = spos.xyz + ipos;
    spos = float4(_166.x, _166.y, _166.z, spos.w);
